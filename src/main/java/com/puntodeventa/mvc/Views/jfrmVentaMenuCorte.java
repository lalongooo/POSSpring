 ...
 * @author USER
 */
public class jfrmVentaMenuCorte extends javax.swing.JDialog {

    private ValidacionForms valid = new ValidacionForms();
    private CorteLogic crtLgc = new CorteLogic();

    public jfrmVentaMenuCorte(jfrmVenta parent, boolean modal) {
        super(parent, modal);
        initComponents();
        configureControls();
        setClock();
    ...
    private void setTags() {
        this.jlblCorteTitle.setText(TagHelper.getTag("jfrmVentaMenuCorte.CorteTitle"));
        ...
        this.jBtnCut.setText(TagHelper.getTag("jfrmVentaMenuCorte.Cut"));
    ...
    private void initComponents() {
        ...
        jlblCorteTitle = new javax.swing.JLabel();
        ...
        jlblCorteTitle.setFont(new java.awt.Font("Tahoma", 0, 21)); // NOI18N
        jlblCorteTitle.setText("Corte de caja");
        ...
        jBtnCut.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jBtnCut.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/iconDone.png"))); // NOI18N
        jBtnCut.setText("Realizar corte");
        jBtnCut.setMaximumSize(new java.awt.Dimension(93, 29));
        jBtnCut.setMinimumSize(new java.awt.Dimension(93, 29));
        jBtnCut.setPreferredSize(new java.awt.Dimension(93, 29));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jBtnCut, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jBtnCut, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jBtnCutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnCutActionPerformed
        ...
        if (a && b) {
            ...
            if (op == 0) {
                ...
                dispose();
                valid.msjInfo(null, TagHelper.getTag("jfrmVentaMenuCorte.exitConfirmation"));
                System.exit(0);
            }
        }
    ...
    private javax.swing.JLabel jlblCorteTitle;
